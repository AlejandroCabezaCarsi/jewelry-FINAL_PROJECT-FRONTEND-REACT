      ...
      <Container className="fontSize text-center p-3">
        ...
        <Row>
          ...
          <Col xs={12} sm={12} md={12} lg={2}>
            <div className="userCardEmail mt-2 scrollIfNeeded">
              {postalCode}
            </div>
          </Col>
        ...
        <Row className="d-flex justify-content-around mt-4">
          ...
          deleted_at === undefined ? null : (
            <Col
              ...
              onClick={() => navigate(`/RestoreUserAccount/${id}`)}
            >
              <div className="restoreAccount buttonUserCardDetail">
                REACTIVAR CUENTA
              </div>
            </Col>
          )}
          ...
          <Col
            ...
            lg={3}
            className="d-flex justify-content-center align-items-center"
            onClick={() => navigate(`/DestroyAccount/${id}`)}
          >
            <div className="deleteAccount buttonUserCardDetail">
              ELIMINAR CUENTA{" "}
            </div>
          </Col>
        </Row>
