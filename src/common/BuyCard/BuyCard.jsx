        ...
        <Row className="d-flex flex-row justify-content-around">
          <Col xs={12} sm={5} md={5} lg={5} className="d-flex flex-column">
            ...
            <div className="numberOfProducts">
              Productos:{" "}
              <p className=" ms-1 m-0 p-0 textBold textSize ">
                {products?.length}
              </p>
            </div>
          </Col>
                    ...
                    <Col xs={12} sm={5} md={5} lg={6}>
                      <Row className="d-flex justify-content-center align-items-center ">
                        <Col xs={12} sm={12} md={12} lg={12}>
                          <div className="productReference d-flex flex-row justify-content-around mb-1">
                            Número de referencia:{" "}
                            <p className="ms-3 textBold">{product.reference}</p>
                          </div>
                        </Col>
                        <Col xs={12} sm={12} md={12} lg={12}>
                          <div className="productName d-flex flex-row justify-content-around mb-1">
                            Nombre del producto:{" "}
                            <p className="ms-3 textBold">{product.name}</p>
                          </div>
                        </Col>
                        <Col xs={12} sm={12} md={12} lg={12}>
                          <div className="productPrice d-flex flex-row justify-content-around mb-1">
                            Precio:{" "}
                            <p className="ms-3 textBold">{product.price}€</p>
                          </div>
                        </Col>
                      </Row>
                    </Col>
